...
import { TokenContract } from '../artifacts/js/token_for_new_coin';
import { decrypttoken } from '../artifacts/js/leo2js/token_for_new_coin';
...
describe('deploy test', () => {
  ...
  test('mint private', async () => {
    ...
    const tx = await contract.mint_private(
      'aleo1g24j0aa2fw69y7n05aehk3gp7cf8tr9ea2nnpnavx3qdpmc5r5rse08kl2',
      actualAmount
    );
